...
<<<<<<< HEAD
	...
	public String toString() {
		return "Xml [id=" + id + ", valorMercadoria=" + valorMercadoria + ", pesoBruto=" + pesoBruto + ", pesoLiquido="
				+ pesoLiquido + ", dataEmbarque=" + dataEmbarque + ", dataChegada=" + dataChegada + ", localOrigem="
				+ localOrigem + ", localDestino=" + localDestino + ", empresaOrigem=" + empresaOrigem
